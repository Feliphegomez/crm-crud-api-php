<div class="" id="app">
	<div class="page-title">
		<div class="title_left">
			<h3>Productos y Servicios <small>Portafolio.</small></h3>
		</div>
		<div class="title_right">
			<div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
				<div class="input-group">
					<router-link class="btn btn-default btn-sm" :to="{ name: 'Services-Create' }" tag="a">
						<span data-toggle="tooltip" data-placement="bottom" title="Crear">
							<i class="glyphicon glyphicon-plus"></i>
						</span>
					</router-link>
					<router-link class="btn btn-default btn-sm" :to="{ name: 'Services-List' }" tag="a">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12 text-center">
									<ul class="pagination pagination-split">
										<router-link :to="{ name: 'Services-Filter-Letter', params: { letter_text: letter }}" tag="li" :key="letter" v-for="letter in letters_list">
								...
								<div class="col-md-12 col-sm-12 col-xs-12 text-center">
									<p v-if="$route.params.letter_text != undefined">
										...
										<router-link :to="{ name: 'Services-List' }" tag="a" class="btn btn-default btn-sm">
											Borrar filtro
										</router-link>
									</p>
								...
								<template v-else>
									<div class="col-md-4 col-sm-6 col-xs-12 profile_details" v-for="record in records">
										<div class="well profile_view">
											<div class="col-sm-12">
												<h4 class="brief" data-toggle="tooltip" data-placement="bottom" title="Precio"><i>{{ record.precio }}</i></h4>
												<div class="left col-xs-7">
													<h2 data-toggle="tooltip" data-placement="bottom" title="Titulo">{{ record.title }}</h2>
													<p>
														<strong data-toggle="tooltip" data-placement="bottom" title="Subtitulo">{{ record.subtitle }}  </strong> 
														<span v-for="a in record.services_tags">{{ a.name }} </span>
													</p>
											...
											<div class="col-xs-12 bottom text-center">
												<div class="col-xs-12 col-sm-6 emphasis">
													...
													-->
													<button @click="deleteServices(record.id)" type="button" class="btn btn-danger btn-sm">
														<i class="fa fa-times"></i>
													</button>
												</div>
												<div class="col-xs-12 col-sm-6 emphasis">
													<router-link :to="{ name: 'Services-Edit', params: { services_id: record.id }}" tag="button" type="button" class="btn btn-success btn-sm">
														<i class="fa fa-edit"></i>
													</router-link>
													<router-link :to="{ name: 'Services-Details', params: { services_id: record.id }}" tag="button" type="button" class="btn btn-primary btn-sm">
														<i class="fa fa-eye"></i>
													</router-link>
												</div>
											</div>
							...
							<div class="x_content">
								<div class="col-md-7 col-sm-7 col-xs-12">
									...
									<div class="product_services">
										<!-- //
										<a>
										<img src="https://services.org/pics/2015-04-13/Calif_Sue/af62ef.jpg" alt="..." />
										</a>
										<a>
										<img src="https://services.org/pics/2012-05-01/Calif_Sue/8c7c8e.jpg" alt="..." />
										</a>
										-->
									</div>
								</div>
								...
								<div class="col-md-5 col-sm-5 col-xs-12" style="border:0px solid #e5e5e5;">
									<h3 class="prod_title" title="Titulo">{{ record.title }}</h3>
											...
											<template v-if="item.type === 'text'">
											  <div class="">
												...
												<ul class="list-inline prod_size">
													...
													<router-link :to="{ name: 'Services-Filter-Fields', params: { value_text: val.value }}" tag="li" :key="val.id" v-for="val in item.values">
												...
												<div class="" >
													...
													<ul class="list-inline prod_color">
														<li v-for="val in item.values">
															...
															<router-link :to="{ name: 'Services-Filter-Fields', params: { value_text: val.value }}" tag="div" :key="val.id" class="color bg-" :style="'background: ' + val.value + '!important;cursor:pointer;'">
															</router-link>
														</li>
													</ul>
													<br />
								...
								<div class="col-md-12">
									<div class="col-md-4 pull-right">
										<router-link class="btn btn-default btn-sm" :to="{ name: 'Services-List' }" tag="a"><h4><i class="glyphicon glyphicon-chevron-left"></i> Regresar</h4> </router-link>
									</div>
								</div>
							</div>
						</div>
...
<style scope="services-edit">
.stepContainer {
	height: auto !important;
	overflow: hidden;
}
</style>
<template id="services-edit">
	<div>
		<div class="">
			<div class="page-title">
				<div class="title_left">
				...
				<div class="col-md-12">
					<div id="wizard_verticle" class="form_wizard wizard_verticle">
						<ul class="list-unstyled wizard_steps">
							...
							<form class="form-horizontal form-label-left" :on-submit="onFinishCallback" action="javascript:false;">
							  <span class="section">Info Básica</span>
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3" for="first-name">Titulo <span class="required">*</span></label>
									<div class="col-md-6 col-sm-6">
										<input type="text" v-model="record.title" class="form-control col-md-7 col-xs-12">
									</div>
								</div>
								
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3" for="first-name">Subtitulo </label>
									<div class="col-md-6 col-sm-6">
										<input type="text" v-model="record.subtitle" class="form-control col-md-7 col-xs-12">
									</div>
								</div>

								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3" for="first-name">Precio </label>
									<div class="col-md-6 col-sm-6">
										<input type="text" v-model="record.precio" class="form-control col-md-7 col-xs-12">
									</div>
								</div>
								<div class="form-group">
						  ...
						  <div id="step-22">
							<h2 class="StepTitle"></h2>
							  <span class="section">Agregar Etiquetas</span>
							<div class="x_content">
								<table class="table table-responsive">
									<tr v-for="(comun_name, i) in services_tags">
										<td>{{ comun_name.id }}</td>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label">Nueva Etiqueta</label>
									<div class="col-sm-9">
										<div class="input-group">
...
var ServicesList = Vue.extend({
	...
	methods: {
		getSearch(){
			var self = this;
			if(self.searchText != ""){
				router.push({ name: 'Services-Search', params: { search_text: self.searchText } })
			}
		},
		getServicess(){
			var self = this;
			...
			if(self.$route.params.letter_text != undefined){
				...
				.then(function (r_services_tags) {
					if(r_services_tags.data.records){
						r_services_tags.data.records.forEach(aa => {
							self.services_ids.push(aa.service);
						});
						self.load = {
							params: {
								join: [
								...
								'filter1': [
									'title,sw,' + self.$route.params.letter_text,
								],
								'filter2': [
									'subtitle,sw,' + self.$route.params.letter_text,
								],
								'filter3': [
									'precio,sw,' + self.$route.params.letter_text,
								],
								'filter4': [
									'id,in,' + self.services_ids.join(),
								],
							}
						};
						self.loadList();
				...
				.then(function (r_services_tags) {
					if(r_services_tags.data.records){
						...
						api.get('/records/services_items', {
							params: {
								filter: [
						...
						.then(function (r_services_items) {
							if(r_services_items.data.records){
								r_services_items.data.records.forEach(aa => {
									self.services_ids.push(aa.service);
								});
								...
								self.load = {
									params: {
										...
										'filter1': [
											'title,cs,' + self.$route.params.search_text,
										],
										'filter2': [
											'subtitle,cs,' + self.$route.params.search_text,
										],
										'filter3': [
											'precio,cs,' + self.$route.params.search_text,
										],
										'filter4': [
		...
		loadList(){
			var self = this;
			if(self.load !== null){
				api.get('/records/services', self.load)
		...
		deleteServices(services_id){
			...
			bootbox.confirm({
				...
				callback: function (result) {
					...
					if(result === true){
						api.delete('/records/services/' + services_id, {}).then(function (response) {
...
var ServicesDetails = Vue.extend({
	template: '#services-details',
	data() {
		var self = this;
		return {
			idDetails: self.$route.params.services_id,
			record: null,
			fields: null,
		};
	},
	...
	mounted(){
		...
		api.get('/records/services/' + self.idDetails, {
			params: {
				join: [
					'services_tags',
					'services_items',
					'services_items,services_fields',
				]
			}
		}).then(function (response) {
			if(response.data != undefined){
				if(response.data.services_items){
					self.fields = self.validateFields(response.data.services_items);
				}
...
var ServicesEdit = Vue.extend({
	template: '#services-edit',
	data() {
		var self = this;
		return {
			record: {
				id: self.getServicesId(),
				title: '',
				subtitle: '',
				precio: '',
				picture: null,
	...
	methods: {
		getServicesId(){
			var self = this;
			return (self.$route.params.services_id <= 0 || self.$route.params.services_id == undefined) ? null : self.$route.params.services_id;;
		},
		getPicture(){
			var self = this;
		...
		onFinishCallback(){
			...
			if(self.validateAllSteps()){
				...
				router.push({ name: 'Services-Details', params: { services_id: self.record.id } })
			}
		},
		...
		validateSteps(stepnumber){
			...
			if(stepnumber == 1){
				// console.log("Creacion del services.");
				
				if (self.record.title != "" && self.record.title.length > 1){
					if (self.record.id === null){
						// console.log("Creando");
						api.post('/records/services', self.record)
							.then(function (r) {
						...
						api.put('/records/services/' + self.record.id, self.record)
							.then(function (r) {
								// console.log(r);
							})
							.catch(function (error) {
					...
					alert("Ingresa almenos el Titulo *.");
				}
		...
		removeNameComun(comun_name_id){
			var self = this;
			api.delete('/records/services_tags/' + comun_name_id, {}).then(function (response) {
				 // console.log(response);
				 self.getNamesComunes();
			}).catch(function (error) {
				// console.log(error);// console.log(error.response);
		...
		getNamesComunes(){
			var self = this;
			api.get('/records/services/' + self.record.id, {
				params: {
					join: [
						'services_tags',
						// 'services_items',
				 ...
				 // console.log(response);
				self.services_tags = (!response.data.services_tags) ? [] : response.data.services_tags;
			}).catch(function (error) {
			  // console.log(error);// console.log(error.response);
			});
		...
		addNameComun(){
			var self = this;
			api.post('/records/services_tags', {
				service: self.record.id,
		...
		getFieldsForm(){
			...
			api.get('/records/services_fields', {
				params: {
				}
			}).then(function (response) {
		...
		removeItemField(item_field_id){
			var self = this;
			api.delete('/records/services_items/' + item_field_id, {}).then(function (response) {
				 self.getFields();
			}).catch(function (error) {
				// console.log(error);// console.log(error.response);
			});
		...
		addItemField(){
			...
			if(self.fieldText != "" && self.fields_form[self.fieldSelected].id > 0){
				api.post('/records/services_items', {
					service: self.record.id,
		...
		getRecord(){
			...
			api.get('/records/services/' + self.getServicesId(), {
				params: {
				}
			}).then(function (response) {
				// console.log(response);
...
var router = new VueRouter({
  routes:[
    { path: '/', component: ServicesList, name: 'Services-List' },
    { path: '/filter/letter/:letter_text', component: ServicesList, name: 'Services-Filter-Letter' },
    { path: '/search/:search_text', component: ServicesList, name: 'Services-Search' },
    { path: '/filter/fields/search/:value_text', component: ServicesList, name: 'Services-Filter-Fields' },
    { path: '/create', component: ServicesEdit, name: 'Services-Create', params: { services_id: 0 } },
    { path: '/edit/:services_id', component: ServicesEdit, name: 'Services-Edit'},
    { path: '/details/:services_id', component: ServicesDetails, name: 'Services-Details'},
  ]
});
